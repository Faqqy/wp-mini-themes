...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var rightLeftMenu = document.getElementById('openmenu');
    var openCloseMenu = document.getElementById('openMenuMob');
    var overlayOpenClose = document.getElementById('overlaypage');
    ...
    rightLeftMenu.addEventListener('click', function () {
        openModalAndMenus();
    });
