...
;// CONCATENATED MODULE: ./src/tarif.ts
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // });
    var grid2 = document.querySelector('.mosaik__bottom');
    var msnry2 = new (masonry_default())(grid2, {
        columnWidth: 85,
    ...
    var modalTarifBtn = document.getElementById('gridsBtn');
    var modalTarif = document.getElementById('modalTrf');
    var overlayTarifPage = document.getElementById('overlayTarifs');
    var bodyOverNone = document.getElementById('htmlTop');
    var modalFormButton = document.querySelectorAll('.button__form');
    var modalModalTarifs = document.getElementById('modal__form');
    Array.prototype.forEach.call(modalFormButton, function (e) {
    ...
    modalTarifBtn.addEventListener('click', function () {
        openModalTarifs();
    });
    overlayTarifPage.addEventListener('click', function () {
        closeModal();
    });
...
/******/ })()
;
//# sourceMappingURL=tarifpage.js.map